	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav ml-auto">
				<li class="nav-item"><a href="{{ route('landing',[$userid]) }}" class="nav-link active ">Home</a></li>
   ...
   <!-- <div class="wrapper">
	@foreach ($data as $i)
     <div class="single-service">
               ...
               <img src="{{ asset('frontend') }}/img/girl_avatar.png" alt="Avatar" class="avatar">
                <span></span>
               
                <h3>{{ $i->name }}</h3>
                <h5 class="title">Expert in</h5>
                <h6>{{ $i->field }}</h6>
                <span class="contact"><i class="fa fa-envelope" aria-hidden="true"></i>{{ $i->email }}</span>
                
                <span class="contact" ><i class="fa fa-phone" aria-hidden="true"></i>{{ $i->phone }}</span>
				<a href="takeappointment/{{ $i->id }}" class="btn btn-primary btn-md mt-3">Take Appointment</a>	
            ...
            <div class="card">
                <div class="card-horizontal">
                    ...
                    <div class="card-body">
						...
						<span class="contact">{{ $i->field }}</span>
                ...
                <div class="card-footer text-center">
					...
					<a href="takeappointment/{{ $i->id }}" class="btn btn-primary btn-md mt-3">Take Appointment</a>	
					<a href="{{ route('takeapp',[$i->id]) }}" class="btn btn-primary btn-md mt-3">Take Appointment</a>	
