...
<body>
   ...
   <div class="main">
       <div class="register">
           <h2>Register Here</h2>
           <form id="register" method="post" action="{{ route('checkdate') }}">
           ...
           <input type="hidden" name="Sid" id="name" value="{{ $app->id }}">
           <label>Therapist Name: </label>
           <br>
           <input type="text" name="Sname" id="name" value="{{ $app->name }}">
           <br><br>
         ...
         <input type="submit" value="Select" name="submit" id="submit">
         <br>
